#!/usr/bin/env bash
#
# cheat-on-essay / uninstall.sh
#
# Removes cheat-on-essay skills from Claude Code and/or Codex skill dirs.
#
...
remove_skills() {
  ...
  echo ""
  echo "Removing cheat-on-essay from $label:"
...
echo ""
echo "To re-install: bash install.sh [--codex|--all] (from cheat-on-essay source root)"
echo ""
