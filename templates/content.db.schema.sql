-- cheat-on-essay / content.db.schema
--
-- SQLite schema for the calibration pool when scale demands it.
-- Schema is largely lifted from the cheat-on-content (video) reference implementation; field names renamed to article-domain:
...
CREATE TABLE IF NOT EXISTS articles (
    ...
    platform_url                  TEXT,
    matched_article_folder          TEXT,                     -- path to articles/<...>/
...
INSERT OR REPLACE INTO schema_meta (key, value) VALUES
    ...
    ('source', 'cheat-on-essay templates/content.db.schema.sql');
